        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center text-sm">
            <div className="flex items-center gap-6">
              <a href="tel:+918882519245" className="flex items-center gap-2 hover:text-[#F4B400] transition-colors">
                <Phone className="w-4 h-4" />
                +91 8882519245
              </a>
              <a href="mailto:balajientrepreneurs9@gmail.com" className="flex items-center gap-2 hover:text-[#F4B400] transition-colors">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-48 h-12 flex-shrink-0">
                <Image
                  src="/images/balaji_dark_logo.svg"
