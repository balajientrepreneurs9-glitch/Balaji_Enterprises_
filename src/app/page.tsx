...
export default function HomePage() {
  ...
  return (
    <main className="overflow-x-hidden">
      {/* Hero Section */}
      <section className="w-full relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#081B3A] via-[#081B3A] to-blue-900">
        {/* Background Image */}
        ...
        {/* Content */}
        <div className="w-full relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="max-w-4xl">
            ...
            >
              <motion.p
                ...
                className="text-[#F4B400] font-semibold text-lg mb-4 tracking-wide uppercase"
              >
              ...
              >
                ...
                <span className="text-[#F4B400]">Building Tomorrow.</span>
              </motion.h1>
              ...
              >
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center gap-2 bg-[#F4B400] hover:bg-[#D49A00] text-[#081B3A] px-8 py-4 rounded-full font-bold text-lg transition-all shadow-2xl hover:scale-105"
                >
                  Get Free Quote
      ...
      <section className="w-full py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <StatsCard number={5000} suffix="+" label="Happy Customers" delay={0.1} />
            <StatsCard number={50} suffix="MW+" label="Installed Capacity" delay={0.2} />
            <StatsCard number={15} suffix="+" label="Years Experience" delay={0.3} />
            <StatsCard number={98} suffix="%" label="Customer Satisfaction" delay={0.4} />
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="text-[#F4B400] font-semibold uppercase tracking-wider mb-3">Why Choose Us</p>
            <h2 className="text-4xl md:text-5xl font-bold text-[#081B3A] mb-6">India's Most Trusted Solar Partner</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUs.map((item, index) => (
              ...
              >
                <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-[#F4B400] to-yellow-500 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
                  <item.icon className="w-10 h-10 text-[#081B3A]" />
                </div>
                <h3 className="text-xl font-bold text-[#081B3A] mb-3">{item.title}</h3>
      ...
      <section className="w-full py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="text-[#F4B400] font-semibold uppercase tracking-wider mb-3">Our Services</p>
            <h2 className="text-4xl md:text-5xl font-bold text-[#081B3A] mb-6">Comprehensive Solar Solutions</h2>
            <p className="text-gray-600 text-lg leading-relaxed">
          ...
          <div className="text-center mt-12">
            <Link
              href="/services"
              className="inline-flex items-center gap-2 bg-[#081B3A] hover:bg-blue-900 text-white px-8 py-4 rounded-full font-semibold transition-all shadow-lg hover:shadow-xl hover:scale-105"
            >
              View All Services
              <ArrowRight className="w-5 h-5" />
            </Link>
      ...
      {/* Process Timeline */}
      <section className="w-full py-20 bg-gradient-to-br from-[#081B3A] to-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="text-[#F4B400] font-semibold uppercase tracking-wider mb-3">Our Process</p>
            ...
            {processSteps.map((step, index) => (
              ...
              >
                <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 hover:bg-white/15 transition-all group">
                  <div className="text-6xl font-bold text-[#F4B400]/30 mb-4">
                    {step.number}
                  </div>
      ...
      <section className="w-full py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="text-[#F4B400] font-semibold uppercase tracking-wider mb-3">Our Projects</p>
            <h2 className="text-4xl md:text-5xl font-bold text-[#081B3A] mb-6">Powering India's Future</h2>
            <p className="text-gray-600 text-lg leading-relaxed">
      ...
      <section className="w-full py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="text-[#F4B400] font-semibold uppercase tracking-wider mb-3">Testimonials</p>
            <h2 className="text-4xl md:text-5xl font-bold text-[#081B3A] mb-6">What Our Customers Say</h2>
            <p className="text-gray-600 text-lg leading-relaxed">
      ...
      <section className="w-full py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-[#F4B400] font-semibold uppercase tracking-wider mb-3">FAQ</p>
            <h2 className="text-4xl md:text-5xl font-bold text-[#081B3A] mb-6">Frequently Asked Questions</h2>
            <p className="text-gray-600 text-lg leading-relaxed">
